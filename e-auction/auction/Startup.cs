...
namespace auction
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "e-Auction API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            var counter = Metrics.CreateCounter("auctionapi_path_counter", "Counts requests to the Auction API endpoints", new CounterConfiguration
            {
