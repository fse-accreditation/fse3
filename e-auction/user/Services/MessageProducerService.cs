...
namespace user.Services
{
    public class MessageProducerService: IMessageProducerService
    {
        ...
        public MessageProducerService(ProducerConfig _producerConfig)
        {
         ...
         public async Task WriteMessage(string topicName, UserDetails userBasicDetails)
        {
            var serializedOrderData = JsonSerializer.Serialize<UserDetails>(userBasicDetails);
